...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get user profile with order history' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns user profile with order history' }),
    (0, common_1.HttpCode)(200),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
